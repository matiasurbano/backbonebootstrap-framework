...
var CrudParentController = CrudController.extend({
  ...
  addChildren: function(children) {
    ...
    _.each(children, function(Child) {
      ...
      if (_.findWhere(this.children, { name: child.name })) {
        throw new Error('there already exists a child with the name "' + child.name + '".');
      }
  ...
  selectTab: function(tabName) {
    ...
    var tab = _.findWhere(this.tabs, { name: tabName });
