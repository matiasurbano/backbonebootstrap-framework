...
var DateControl = InputControl.extend({
  ...
  initialize: function(options) {
    ...
    '<div class="input-append date datepicker">' +
      '<input class="span2" type="<%= inputType %>" ' +
   ...
   */
  events: {
    'blur :input'       : function(e) { this.onUpdateControl(e, true); },
    'changeDate :input' : function(e) { this.onUpdateControl(e, true); }
  },
  ...
  onUpdateControl: function(e, forceUpdate) {
    return InputControl.prototype.onUpdateControl.call(this, e, true);
  },
